...
export default function () {
  ...
  const handlePress = () => {
    ...
    if (state.description == "")
      return ToastAndroid.show("Please enter a team description.", ToastAndroid.SHORT);
    if (state.description.length > 200)
      return ToastAndroid.show("Team description cannot be more than 200 characters.", ToastAndroid.SHORT);
    if (state.imageURL == "") return ToastAndroid.show("Please enter a team image URL.", ToastAndroid.SHORT);
